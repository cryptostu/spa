...
#### 完全没有优化，限制leveldb占用内存的情况并关闭swap分区，测试结果如下：

|线程数量|耗时|cpu使用率|内存使用|
|---|---|---|---|
| 8 | 20s 左右 | 80%-90% | 1GB-1.1GB 左右 |
| 16 | 17s 左右 | 80%-100% | 900M-1GB 左右|
| 32 | 16s 左右 | 80%-100% | 1GB 左右|
...
#### 50GB, 未做参数优化，关闭swap，限制内存之后，leveldb性能测试如下：
